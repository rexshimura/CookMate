      ...
      <div className="relative z-10 w-full max-w-md mx-auto sm:max-w-none">
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-stone-900 tracking-tight mb-2">Welcome back</h2>
            <p className="text-stone-600 text-sm sm:text-base">Sign in to continue your culinary journey</p>
          </div>
        </div>
