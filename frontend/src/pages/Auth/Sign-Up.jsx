  ...
  return (
    <div className="min-h-screen bg-stone-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-2 text-center text-3xl font-extrabold text-stone-900">Create your account</h2>
        <p className="mt-2 text-center text-sm text-stone-600">Start your AI cooking journey today.</p>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-stone-100 sm:rounded-2xl sm:px-10 relative overflow-hidden">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="animate-slideUp">
              <label className="block text-xs font-semibold text-stone-600 uppercase tracking-wide mb-1.5">Full Name</label>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-stone-600">
              ...
              <a href="/signin" className="font-semibold text-orange-600 hover:text-orange-500 transition-colors">Log in</a>
            </p>
          </div>
        </div>
      </div>
