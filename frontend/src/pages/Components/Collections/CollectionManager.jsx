...
const CollectionManager = ({
  ...
  const executeDelete = () => {
    onDeleteCollection(deleteConfirmDialog.collectionId);
    setDeleteConfirmDialog({
      isOpen: false,
      collectionId: null,
      collectionName: ''
  ...
  return (
    <div className="bg-gradient-to-b from-white via-stone-50 to-stone-100 rounded-2xl border border-stone-200/60 p-6 shadow-2xl shadow-stone-900/10 backdrop-blur-xl transition-all duration-500 ease-out">
      ...
      <ConfirmationDialog
        ...
        title="Delete Collection"
        message={`Are you sure you want to delete the collection "${deleteConfirmDialog.collectionName}"? This action cannot be undone.`}
        type="danger"
        confirmText="Delete"
        cancelText="Cancel"
      />
